  ...
  return (
    ...
    >
      ...
      <div className="flex md:flex-row flex-col items-center space-x-5 md:space-y-0 space-y-10">
        <a
          href="./project1"
          className="group rounded-lg border border-black px-5 md:ml-0 ml-4 py-4 bg-orange-200 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 hover:-translate-y-2"
        >
          ...
          <h2 className="mb-3 text-2xl font-semibold font-heading">
            NIKE Target Cost App
          </h2>
          <p className="mb-3 max-w-[36ch] text-sm opacity-80 font-sans font-medium">
            React.js, Tailwind, Python (Flask, Sklearn), AWS
          </p>
          <p className="mb-3 max-w-[40ch] text-sm opacity-70 font-sans">
            Created a full stack application using React and Flask that
            leveraged an ML model to predict and easily set target manufacturing
            costs for new shoe models.
          </p>
        </a>
